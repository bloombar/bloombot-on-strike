        ...
        <div className="relative overflow-hidden rounded-lg flex flex-col items-center justify-center bg-black">
          ...
          <div className="absolute top-3 left-3 flex items-center gap-2">
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-black/60 backdrop-blur-sm">
              ...
              />
              <span className="text-xs text-white/70 font-medium uppercase tracking-wider">{sessionState}</span>
            </div>
            <span
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-3 flex flex-col gap-2" style={{ scrollbarWidth: 'none' }}>
              {chatMessages.length === 0 && (
                <p className="text-gray-500 text-xs text-center mt-8">Transcriptions will appear here</p>
              )}
