      ...
      {!sessionToken ? (
        <div className="w-full max-w-lg flex flex-col items-center gap-6 p-8">
          <div className="text-center mb-2">
            <h1 className="text-2xl font-semibold text-white mb-1">LiveAvatar Demo</h1>
            <p className="text-sm text-gray-400">Choose a session mode to get started</p>
          </div>
          ...
          <div className="w-full flex flex-col items-center gap-3 pt-6 border-t border-white/10">
            <span className="text-xs text-gray-500 uppercase tracking-wider">Or use an existing token</span>
            <input
              type="text"
              value={manualToken}
