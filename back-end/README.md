# Bloombot-on-Strike (Back-End)

Based on Zoom's [Zoom's Meeting SDK Auth Endpoint sample](https://github.com/zoom/meetingsdk-auth-endpoint-sample)
...
2. Rename `.env.example` to `.env`, edit the file contents to include your [Zoom Meeting Oauth client key and secret](https://developers.zoom.us/docs/meeting-sdk/developer-accounts/), save the file contents, and close the file.

3. Install depdnencies and start
...
1. After clicking the "Deploy to <Provider\>" button, enter a name for your app (or leave it blank to have a name generated for you), and insert your [Zoom Meeting SDK credentials](https://developers.zoom.us/docs/meeting-sdk/developer-accounts/#get-meeting-sdk-credentials):
   - `ZOOM_OAUTH_CLIENT_ID` (Your Zoom Meeting SDK Key or Client ID for Meeting SDK app type's created after February 11, 2023, found on your Zoom Meeting SDK App Credentials page)
   - `ZOOM_OAUTH_CLIENT_SECRET` (Your Zoom Meeting SDK Secret or Client Secret for Meeting SDK app type's created after February 11, 2023, found on your Zoom Meeting SDK App Credentials page)
